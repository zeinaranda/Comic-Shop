...
$member = array_reverse (query("SELECT * FROM keranjang"));
                            ...
                            <tbody id="tampil">
                                ...
                                <?php foreach ($member as $row) : ?>
                                    <tr>
                                        ...
                                        <td><?php echo $row["idkeranjang"]; ?></td>
                                        ...
                                        <td>
                                             <a href="hapuskeranjang.php?id=<?php echo $row["idkeranjang"]; ?> " onclick="return confirm('Yakin Ingin Menghapus Data?');" class="btn btn-danger btn-sm">Hapus</a>
                                        </td>
                                    </tr>
                                    <?php $i++; ?>
                                <?php endforeach; ?>
