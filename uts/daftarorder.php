...
$member = array_reverse (query("SELECT * FROM orderuser"));
                            ...
                            <tbody>
                                ...
                                <?php foreach ($member as $row) : ?>
                                    <tr>
                                        ...
                                        <td>
                                             <a href="hapusorder.php?id=<?php echo $row["idorder"]; ?> " onclick="return confirm('Yakin Ingin Menghapus Data?');" class="btn btn-danger btn-sm">Hapus</a>
                                        </td>
                                    </tr>
                                    <?php $i++; ?>
                                <?php endforeach; ?>
